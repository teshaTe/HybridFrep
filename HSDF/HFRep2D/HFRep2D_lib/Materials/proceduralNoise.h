...
public:
    ...
    procNoise(const int resX, const int resY, const int seed, const unsigned permTableSize);
    ~procNoise() {}
    ...
    sf::Image getObjectImage(const HObj_single_mat obj, std::vector<colRegion> regions);
