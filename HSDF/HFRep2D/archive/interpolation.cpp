...
void interpolate::smoothField(std::vector<float> *inField, interpolation interType)
{
    finField.clear();
...
void interpolate::interpolateField(std::vector<float> *inField, int curGridW, int curGridH, int curGridD, interpolation interType)
{
    finField.clear();
